...
| 8.8 用户验收测试 | 客户代表按实际业务场景验收 | 本地自测、视觉验证、用户手册已有 | 未完成 | 缺客户代表或项目负责人签字、场景脚本、问题闭环记录 |
...
测试交付当前处于“本地自测和联调准备完成、外部/生产/工业验收待补”状态。不能把本地测试报告等同于 PRD 第八章的最终完整测试验收；最终版测试报告必须并入 STM32、AINAS、MQTT.fx/mosquitto、Modbus Poll/Slave、RK release、LoRA、自进化、安全扫描、工业 30 天和用户签字证据。
